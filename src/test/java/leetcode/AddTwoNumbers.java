...
public class AddTwoNumbers {
    ...
    private boolean hasNext(ListNode list) {
        return list.next != null;
    }

    private ListNode convertIntToList(int number) {
        var strNumber = Integer.valueOf(number).toString();
    ...
    @DataProvider(name = "addTwoNumbersCases")
    ...
    @Test(dataProvider = "addTwoNumbersCases")
    public void addTwoNumbersTests(int firstNumber, int secondNumber) {

        var firstList = convertIntToList(firstNumber);
        var secondList = convertIntToList(secondNumber);
        var expected = firstNumber + secondNumber;

        var sumList = addTwoNumbers(firstList, secondList);
        int actual = Integer.valueOf(convertListToString(sumList));
